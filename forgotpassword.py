...
usernamelabel.place(x=30, y=110)


# create password
newPasswordLabel = customtkinter.CTkLabel(
    master=frame, text="New Password", font=("ariel", 18)
)
...
confirmPasswordLabel.place(x=30, y=280)
...
confirmPasswordEntry.place(x=800, y=700)
